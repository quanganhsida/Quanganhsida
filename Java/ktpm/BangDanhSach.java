...
public class BangDanhSach extends javax.swing.JFrame {
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        if(tblModel.getRowCount() == 0){ //if table is empty
            JOptionPane.showMessageDialog(this, "The table is empty!");
        }
        else{ //if table is not empty
            String Phuong, SoNha, HoVaTen, NamSinh, CCCD, SoDienThoai, GioiTinh, TinhTrangSucKhoe;
            try{
                Class.forName("com.mysql.jbdc.Driver");
                Connection conn = DriverManager.getConnection("jbdc:mysql://localhost:3306/demo1", "root", "");
                for(int i = 0; i < tblModel.getRowCount();  i++){
                    ...
                    CCCD = tblModel.getValueAt(i, 4).toString();
                    SoDienThoai = tblModel.getValueAt(i, 5).toString();
                    GioiTinh = tblModel.getValueAt(i, 6).toString();
                    TinhTrangSucKhoe = tblModel.getValueAt(i, 7).toString();
                    
                    String query = "INSERT INTO `bkpc-covid`(`Phuong`, `SoNha`, `HoVaTen`, `NamSinh`,"
                            + " `CCCD`, `SoDienThoai`, `GioiTinh`, `TinhTrangSucKhoe`) "
                            + "VALUES ('?','?','?','?','?',"
                            + "'?','?','?')";
                    ...
                    prepstmt.setString(5, CCCD);
                    prepstmt.setString(6, SoDienThoai);
                    prepstmt.setString(7, GioiTinh);
                    prepstmt.setString(8, TinhTrangSucKhoe);
